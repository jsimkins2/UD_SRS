...
fig.patches.extend([plt.Rectangle((bottomrecx,bottomrecy),0.7752,0.0232,
                      ...
                      transform=fig.transFigure, figure=fig)])
title = 'NCEP Stage IV Precipitation Totals - 1 Week Aggregation'
timestr = str(pd.to_datetime(newtimestamp)) + ' UTC'
clabeltext = "Last Week Precipitation Totals (inches)"
...
fig.savefig(workdir + "/ncep_stageIV/ncepStageIV_conus_week.png", dpi=dpi, bbox_inches='tight', transparent=False)
plt.close()
...
fig.savefig(workdir + "/ncep_stageIV/ncepStageIV_midatlantic_week.png", dpi=dpi, bbox_inches='tight', transparent=False)
plt.close()
...
ax.outline_patch.set_visible(False)
ax.background_patch.set_visible(False)
fig.savefig(workdir + "/ncep_stageIV/ncepStageIV_conus_day.png", dpi=dpi, bbox_inches='tight', transparent=False)
plt.close()
...
fig.savefig(workdir + "/ncep_stageIV/ncepStageIV_midatlantic_day.png", dpi=dpi, bbox_inches='tight', transparent=False)
plt.close()
...
fig.patches.extend([plt.Rectangle((bottomrecx,bottomrecy),0.7752,0.0232,
                      fill=True, facecolor='darkslateblue', zorder=3, alpha=1,
                      transform=fig.transFigure, figure=fig)])
title = 'NCEP Stage IV Precipitation Totals - 1 Hour Aggregation'
timestr = str(pd.to_datetime(newtimestamp)) + ' UTC'
clabeltext = "Last Hour Precipitation Totals (inches)"
fig.text(toptextright, toptext,timestr,horizontalalignment='left', color = 'white', size=14, zorder=2000)
fig.text(bottomtextleft, toptext,title,horizontalalignment='left', color = 'white', size=14, zorder=2000)
fig.text(bottomtextleft,bottomtextheight,clabeltext,horizontalalignment='left', color = 'white', size=14, zorder=2000)
im1 = image.imread("/home/james/ncep_stageIV/zfolder/udelcemagoes38.png")
...
ax.outline_patch.set_visible(False)
ax.background_patch.set_visible(False)
fig.savefig(workdir + "/ncep_stageIV/ncepStageIV_conus_hour.png", dpi=dpi, bbox_inches='tight', transparent=False)
plt.close()
...
fig.savefig(workdir + "/ncep_stageIV/ncepStageIV_midatlantic_hour.png", dpi=dpi, bbox_inches='tight', transparent=False)
plt.close()
