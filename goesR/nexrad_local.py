...
def plot_velocity(radar, dataset, imgdir):
    ...
    my_ax.add_feature(political_boundaries, linestyle='-', edgecolor='lightgray', linewidth=0.5)
    my_ax.add_feature(states, linestyle='-', edgecolor='lightgray',linewidth=1.5)
