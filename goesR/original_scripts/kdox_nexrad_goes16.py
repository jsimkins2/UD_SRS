...
# if all of the PNGs have already been created, then we can just skip all of this
if len(ABI_datetime) > 0:
    ...
    if len(abi_match) > 0:
        ...
        print "All PNGs have already been made for available data"
