...
if os.path.isfile("/home/sat_ops/goesR/data/sst/" + str(nowdate.year) + "/" + str(dataset)) == False:
    dataset.download("/home/sat_ops/goesR/data/sst/" + str(nowdate.year) + "/" + str(dataset))
