...
# C is for Conus File
C_file = 'OR_ABI-L2-CMIPC-M3C02_G16_s20180311647257_e20180311650030_c20180311650141.nc'  # GOES16 East
C = Dataset(C_file, 'r')
# Load the RGB arrays and apply a gamma correction (square root)
R = C.variables['CMI'][:].data # Band 2 is red (0.64 um)
R = block_mean(R, 2)

C_file = 'OR_ABI-L2-CMIPC-M3C03_G16_s20180311647257_e20180311650030_c20180311650102.nc'  # GOES16 East
C = Dataset(C_file, 'r')
# Load the RGB arrays and apply a gamma correction (square root)
G = np.sqrt(C.variables['CMI'][:].data) # Band 3 is "green" (0.865 um)

C_file = 'OR_ABI-L2-CMIPC-M3C01_G16_s20180311647257_e20180311650030_c20180311650109.nc'  # GOES16 East
C = Dataset(C_file, 'r')
# Load the RGB arrays and apply a gamma correction (square root)
...
H = np.load("/Users/leathers/Downloads/").item()
