...
ABI_datetime = []
for i in match:    
    if os.path.isfile("/home/sat_ops/goes_r/cloud_prod/noaa_format/meso/special_image/" + str(i) + ".png") == False:
        ABI_datetime.append(i)

print ABI_datetime

# now grab the location information from site of interest
