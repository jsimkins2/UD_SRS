# create gif out of last 6 files in nexrad kdox
...
for i in seq:
    ...
    m.scatter(-75.7506,39.6780,marker='*',s=20,color='k',ax=ax,latlon=True) # UDEL star
    ...
    #display the figure
    #plt.plot()
    output_file = '/Users/leathers/Downloads/kdox_nexrad' + str(abs(i)) + '.png'
...
images = []
for i in seq:
    input_file='/Users/leathers/Downloads/kdox_nexrad' + str(abs(i)) + '.png'
    images.append(imageio.imread(input_file))
imageio.mimsave('/Users/leathers/Downloads/kdox_nexrad.gif', images, duration=.6)
