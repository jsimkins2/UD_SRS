...
if (!file.exists(paste0("/data/aquaGoesSST/F/SSTanomalyGoesAqua8dayFahrenheit", jdayGoes, ".nc"))){
  sst <- ncvar_get(d, "sst")
  ...
  loc.file <- paste0("/home/sat_ops/goesR/jpl_sst/sstClimatology/SSTanomalyGoesAqua8dayFahrenheit", jdayGoes, ".nc")
