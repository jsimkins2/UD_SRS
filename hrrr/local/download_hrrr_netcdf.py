...
if os.path.isfile(datadir + dataset_name[:-5] + 'nc') == False:
    ...
    os.system("Rscript /Users/james/Documents/Github/UD_SRS/hrrr/local/reproject_hrrr.R " + dataset_name[:-5] + 'nc')

if os.path.isfile(datadir + 'gridsurf.npy') == False:
    print('regridding the hrrr')
    os.system("python3 /Users/james/Documents/Github/UD_SRS/hrrr/local/regrid_hrrr.py")
