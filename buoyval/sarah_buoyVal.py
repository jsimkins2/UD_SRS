...
for s in list(stations.keys()):
    ...
    buoy_nc = buoy_nc.sel(time = slice('2019-06-01', '2019-09-20'))
    ...
    goes_nc = xr.open_dataset('http://basin.ceoe.udel.edu/thredds/dodsC/GOESNOAASST.nc')
    ...
    goes_nc = goes_nc.sel(time = slice('2019-06-01', '2019-09-20'))
    ...
    if len(buoy_nc.time.values) > 1:
        ...
        if len(buoy_vals) > 1:
            ...
            plt.savefig("/Users/james/Documents/Delaware/buoy_val/sarah_images/buoy" + s)
            plt.close()
