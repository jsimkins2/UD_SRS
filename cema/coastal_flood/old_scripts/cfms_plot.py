...
data = pd.read_csv("/Users/james/Documents/Delaware/cema/coastal_flood/water_levels.csv")
data.index = data.station

# shapefile
shp = shpreader.Reader('/Users/james/Documents/Delaware/cema/coastal_flood/cfms_watersheds/cfms_watersheds.shp')
...
plt.savefig('/Users/james/Downloads/dbofspython_stamen.png', transparent=True, bbox_inches='tight', dpi=90)
