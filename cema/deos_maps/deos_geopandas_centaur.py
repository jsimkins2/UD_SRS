...
stat = os.stat("/var/www/html/deos_json/map_data.json")
...
if diff_time.seconds < 70:
    ...
    # declare paths
    shapePaths = "/home/james/deos_maps/mapLayers/"
    colorPaths = "/home/james/deos_maps/colorramps/"
    my_dpi = 100
    ...
    for var in list(nameDict.keys()):
        ...
        if var == 'Wind Direction' or var == 'Wind Chill':
            ...
            da.rio.to_raster('/home/james/deos_maps/temp/' + nameDict[var] + '.tif', overwrite=True)
            
            xds = rioxarray.open_rasterio('/home/james/deos_maps/temp/' + nameDict[var] +'.tif')
            ...
            plt.savefig("/var/www/deos/images/home_map/deos_" + nameDict[var] + ".png",bbox_inches='tight',pad_inches = 0,dpi=my_dpi*1.3)
    ...
    im1 = image.imread(shapePaths + "deos_logo.png")
    plt.figimage(im1, 24, 40 ,zorder=30, alpha=1)
    plt.savefig("/var/www/deos/images/home_map/deos_wdir.png",bbox_inches='tight',pad_inches = 0,dpi=my_dpi*1.3)
    ...
    da.attrs['standard_name'] = 'Temperature'
    da.rio.set_spatial_dims('lon', 'lat')
    da.rio.to_raster('/home/james/deos_maps/temp/FeelsLike.tif', overwrite=True)
    
    xds = rioxarray.open_rasterio('/home/james/deos_maps/temp/FeelsLike.tif')
    # clip the interpolated data based on the shapefiles
    clipped = xds.rio.clip(deos_boundarys.geometry.apply(mapping), xds.rio.crs, drop=True)
    cl = clipped.rio.clip(inland_bays.geometry.apply(mapping), oldproj.proj4_init, drop=False, invert=True)
    ...
    im1 = image.imread(shapePaths + "deos_logo.png")
    plt.figimage(im1, 24, 40 ,zorder=30, alpha=1)
    plt.savefig("/var/www/deos/images/home_map/deos_feelslike.png",bbox_inches='tight',pad_inches = 0,dpi=my_dpi*1.3)
else:
